...
loader = Neo4jLoader(uri="bolt://localhost:7687", username="neo4j", password="neo4jneo4j")
...
hospital_cypher_chain.invoke("What are the product(s) that Michael ordered?")
hospital_cypher_chain.invoke(' What is the least sold article price per category?')
